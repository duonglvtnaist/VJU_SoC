...
#define PADDING_BASE	     0x0001000000  // 16MB Ofset to avoid system files
#define READ_BASE            0x0000100000

#define IN_DMA_BASE          0x0000000000+PADDING_BASE  
...
int main() {
    ...
    printf("ZCU102: Hello World! Today Is Monday\n");
